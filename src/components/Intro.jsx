    ...
    <section className="py-[75px] lg:py-[100px]">
      <div className="wrapper">
        ...
        <div className='flex flex-col md:flex-row relative'>
            <div className="aspect-video md:flex-1 border-[16px] -ml-[16px] mr-[32px] -mt-[16px] md:mb-[80px] md:-mr-[64px] border-offWhite rounded-[50px] overflow-hidden -z-[1]">
            <img src={introImg1} alt="" className="w-full h-full object-cover"/>
            </div>
            <div className="aspect-video md:flex-1 border-[16px] -mt-[64px] -mr-[16px] ml-[32px] md:mt-[80px] md:-ml-[64px] border-offWhite rounded-[50px] overflow-hidden">
