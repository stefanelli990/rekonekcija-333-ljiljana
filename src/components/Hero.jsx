export default function Hero() {
  return (
    <section id="hero" className="relative">
        <video autoPlay muted preload="auto" loop id="myVideo" className="absolute inset-0 w-full h-full object-cover -z-[2]">
        ...
        <img className="relative inset-x-0 -bottom-[1px] w-full" src="/wavy-vector.svg" alt="Wavy vector" />
    </section>
  )
}