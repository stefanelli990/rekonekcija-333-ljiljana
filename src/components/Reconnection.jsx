...
export default function Reconnection() {
  ...
  return (
    <section id="rekonekcija" className="pb-[50px] lg:pb-[100px]">
      {reconnection.map((item, index) => (
        <div
          key={index}
          className={`wrapper flex md:items-center flex-col-reverse gap-12 md:flex-row lg:gap-24 pt-[50px] lg:pt-[100px] ${index % 2 === 0 ? 'md:flex-row md:text-right' : 'md:flex-row-reverse md:text-left'}`}
        >
