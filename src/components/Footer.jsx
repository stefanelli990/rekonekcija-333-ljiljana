...
export default function Footer() {
  ...
  return (
    <footer>
        ...
        <div>&copy; {currentYear} Rekonekcija 333 Ljiljana. <br /> Developed by <a href="https://github.com/stefanelli990" target="_blank" className="text-primaryColor">stefanelli990</a></div>
        </div>
        </div>
    </footer>
  )
